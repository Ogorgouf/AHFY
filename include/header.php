    ...
    <div id="btn_header">
        ...
        <div class='déroulant'>
            <ul>
                ...
                <hr>
                <li class="sous_liens"><div class="sous_div"><a class="lien "  href="generation80.php">génération 80</a><div class="membres">
                ...
                <hr>
                <li class="sous_liens"><div class="sous_div"><a class="lien"  href="generation90.php">génération 90</a><div class="membres">
                    <ul>
                    <li class="sous_liens"><div class="sous_div"><a class="lien"  href="">Listes des membres</a> </div></li>
                    <hr>
                    <li class="sous_liens"><a class="lien" href="">Profil admin</a></li>
        ...
        <ul>
                ...
                <hr>
                <li class="sous_liens"><div class="sous_div"><a class="lien"  href="nkenah.php">NKENAH</a><div class="membres">
                    <ul>
                    <li class="sous_liens"><div class="sous_div"><a class="lien"  href="">Listes des membres</a> </div></li>
                    <hr>
                    <li class="sous_liens"><a class="lien" href="">Profil admin</a></li>
                ...
                <hr>
                <li class="sous_liens"><div class="sous_div"><a class="lien"  href="madzong.php">MADZONG</a><div class="membres">
                    <ul>
                    <li class="sous_liens"><div class="sous_div"><a class="lien"  href="">Listes des membres</a> </div></li>
                    <hr>
                    <li class="sous_liens"><a class="lien" href="">Profil admin</a></li>
       ...
       <ul>
                ...
                <hr>
                <li class="sous_liens"><div class="sous_div"><a class="lien"  href="coredef.php">COREDEF</a><div class="membres">
                        <ul>
                        <li class="sous_liens"><div class="sous_div"><a class="lien"  href="">Listes des membres</a> </div></li>
                        <hr>
                        <li class="sous_liens"><a class="lien" href="">Profil admin</a></li>
