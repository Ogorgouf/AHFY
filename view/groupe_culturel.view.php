...
<html lang="fr">
<head>
<?php $current = "groupe_culturel" ?>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <?php include("include/link.php") ?>
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Groupes Culturels</title>
</head>
<body>
...
<section  class="premiere_vue">
    <div  class="presentation">
       <span class="nom_association">les groupes cuturels fokoué</span><br>
       <span class="slogan">Nos groupes culturels et toutes nos associations  </span>
    </div>
