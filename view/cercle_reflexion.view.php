...
<?php $current = "cercle_reflexion" ?>
    ...
    <title>Cercle de reflexion</title>
</head>
<body>
...
<section  class="premiere_vue">
    <div  class="presentation">
       <span class="nom_association">cercles de reflexions</span><br>
       <span class="slogan">la table ronde de prise de décision des associations</span>
    </div>
